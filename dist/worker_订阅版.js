...
var require_sha224 = __commonJS({
  "src/sha224.js"(exports, module) {
    ...
    __name(isValidSHA224, "isValidSHA224");
    module.exports = {
...
var require_addressHandle = __commonJS({
  "src/addressHandle.js"(exports, module) {
    ...
    function ipsPaging2(ipsArray, maxNode, page, upperLimit = 500, defaultCount = 300) {
...
var require_crawler = __commonJS({
  "src/crawler.js"(exports, module) {
    ...
    __name(fetchGitHubFile2, "fetchGitHubFile");
    async function fetchWebPageContent2(url) {
      try {
    ...
    __name(fetchWebPageContent2, "fetchWebPageContent");
    module.exports = {
...
var require_output = __commonJS({
  "src/output.js"(exports, module) {
    ...
    function getBaseConfig2(pswd, hostName) {
      ...
      const finallyLink = base64Decode2(base64Link).replace(regex1, (match) => {
        if (match === "#onTls#") {
          return isCFworkersDomain ? "none" : base64Decode2("dGxzJnNuaT0jaG9zdCMmZnA9Y2hyb21lJmFsbG93SW5zZWN1cmU9MQ").replace("#host#", hostName);
        }
...
####################################################################################################################
    ...
    __name(getBaseConfig2, "getBaseConfig");
    ...
    function buildLinks2(ipsArrayChunked, hostName, pswd, defaultPort) {
      let LinkArray = [];
    ...
    __name(buildLinks2, "buildLinks");
    function buildYamls2(ipsArrayChunked, hostName, pswd, defaultPort) {
      let proxyies = [];
      let nodeNames = [];
    ...
    __name(buildYamls2, "buildYamls");
    function buildJsons2(ipsArrayChunked, hostName, pswd, defaultPort) {
      let outbds = [];
      let nodeNames = [];
...
var { hash224Encrypt } = require_sha224();
var { parseHostPort, ipsPaging } = require_addressHandle();
...
__name(extractGroupedEnv, "extractGroupedEnv");
...
async function handleRequest(path, config, nodePassword, defaultMaxNodeMap2) {
  ...
  __name(isGitHubConfigComplete, "isGitHubConfigComplete");
